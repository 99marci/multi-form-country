...
const Preview = (props: Props): ReactElement => {
    ...
    const elements = (): ReactElement[] => {
        ...
        for (const key in props.previousSteps) {
            const value = (typeof props.previousSteps[key] === 'object') ? (props.previousSteps[key] as FileList)[0].name : props.previousSteps[key];
            returnArray.push(<div key={Math.random() * 1000} className="my-3">
